...
const About = () => {
  return (
    <div>
        <br /><br /><br /><br /><br /> <br />
        <h1 className='text-6xl font-bold text-center font-sans '>About</h1>
        {/* <hr  className='font-bold mt-2'/> */}
      <div className="relative overflow-hidden mt-12 bg-white">
  <div className="pb-80 pt-16 sm:pb-40 sm:pt-24 lg:pb-48 lg:pt-40 mt-8">
